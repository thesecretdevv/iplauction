    ...
    return (
        <div style={{ minHeight: "100vh", background: BG, fontFamily: "'Rajdhani',sans-serif", padding: "30px", display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <div style={{ animation: "fadeUp .4s ease-out", textAlign: "center", marginBottom: 20 }}>
                <div style={{ fontFamily: "'Bebas Neue'", fontSize: "clamp(24px,3.5vw,42px)", color: GOLD, letterSpacing: 6 }}>BITWICKET IPL AUCTION LOBBY</div>
            ...
            {isHost && (
                <div style={{ marginBottom: 20, textAlign: "center" }}>
                    <div style={{ fontSize: 10, color: "#888", letterSpacing: 3, marginBottom: 10 }}>BITWICKET IPL AUCTION MODE</div>
            ...
            {!isHost && auctionMode && <div style={{ color: "#999", fontSize: 12, marginBottom: 16 }}>Mode: {auctionMode === "mega" ? "BITWICKET IPL MEGA AUCTION" : "BITWICKET IPL MINI AUCTION"}</div>}
